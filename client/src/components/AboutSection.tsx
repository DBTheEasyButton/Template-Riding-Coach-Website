      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div>
              <h2 className="text-5xl font-playfair font-bold text-forest mb-6">About Dan</h2>
              <div className="w-24 h-1 bg-italian-red mb-8"></div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              <div className="text-center">
                <div className="text-3xl font-playfair font-bold text-italian-red">15+</div>
                <div className="text-gray-600 mt-2">Years Professional</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-playfair font-bold text-italian-red">3</div>
                <div className="text-gray-600 mt-2">Olympic Games</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-playfair font-bold text-italian-red">25+</div>
                <div className="text-gray-600 mt-2">International Medals</div>
              </div>
            </div>
          </div>
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-6 -right-6 bg-forest text-white p-6 rounded-xl shadow-xl">
              <div className="flex items-center space-x-3">
                <i className="fas fa-flag text-italian-red text-2xl"></i>
                <div>
