...
export default function AchievementsSection() {
  ...
  return (
    <section id="achievements" className="py-24 bg-gradient-to-br from-navy to-slate-800 text-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center transform hover:scale-105 transition-all duration-300">
            ...
            {olympicAchievements.length > 0 ? (
              olympicAchievements.map((achievement, index) => (
                <p key={index} className="text-slate-100 mb-2">
                  {achievement.location} {achievement.year} - {achievement.position}
                </p>
              ))
            ) : (
              <>
                <p className="text-slate-100 mb-4">Tokyo 2021 - Team Bronze</p>
                <p className="text-slate-100 mb-4">Rio 2016 - 8th Individual</p>
                <p className="text-slate-100">London 2012 - Team 4th</p>
              </>
            )}
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center transform hover:scale-105 transition-all duration-300">
            ...
            {worldAchievements.length > 0 ? (
              ...
              <>
                <p className="text-slate-100 mb-4">Tryon 2018 - Team Silver</p>
                <p className="text-slate-100 mb-4">Normandy 2014 - Team Bronze</p>
                <p className="text-slate-100">Kentucky 2010 - 12th Individual</p>
              </>
            )}
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center transform hover:scale-105 transition-all duration-300">
            ...
            {europeanAchievements.length > 0 ? (
              ...
              <>
                <p className="text-slate-100 mb-4">Avenches 2021 - Team Gold</p>
                <p className="text-slate-100 mb-4">Strzegom 2017 - Individual Bronze</p>
                <p className="text-slate-100">Blair 2015 - Team Silver</p>
              </>
            )}
          </div>
        </div>
              ...
              {recentAchievements.length === 0 && (
                <>
                  <div className="flex items-start space-x-4">
                    <div className="bg-orange rounded-full w-3 h-3 mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold text-lg">Badminton Horse Trials 2023</h4>
                      <p className="text-slate-100">2nd Place - Riding Castello Primo</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="bg-orange rounded-full w-3 h-3 mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      <p className="text-slate-100">1st Place - Riding Venetian Dream</p>
                    </div>
                  </div>
                </>
              )}
