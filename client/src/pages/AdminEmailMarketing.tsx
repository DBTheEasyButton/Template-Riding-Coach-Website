...
export default function AdminEmailMarketing() {
  ...
  const convertTextToHtml = (textContent: string, includeLogo: boolean = true): string => {
...
<p style="font-size: 12px; color: #666; text-align: center;">
  ...
  const createTemplateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setTemplateForm({ name: "", subject: "", htmlContent: "", textContent: "", templateType: "newsletter", includeLogo: true });
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Textarea
                      ...
                      onChange={(e) => {
                        ...
                        const autoGeneratedHtml = convertTextToHtml(newTextContent, templateForm.includeLogo);
                        setTemplateForm({ 
                          ...templateForm, 
                          textContent: newTextContent,
                          htmlContent: autoGeneratedHtml
                        });
                      }}
                      rows={6}
                    />
                    <p className="text-xs text-gray-500">
                      HTML content above will be automatically generated from this text. URLs and email addresses will become clickable.
                    </p>
                    <div className="flex gap-2">
                      <Button 
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 mt-1 space-y-1">
                        ...
                        <p>Newsletter templates: Use {`{{upcomingClinicsHtml}}`} to show next 2 clinics and {`{{recentNewsHtml}}`} for latest 2 blog posts</p>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => {
                          const newTextContent = e.target.value;
                          const hasLogo = editingTemplate.htmlContent?.includes('danbizzarromethod.com/logo.png') || false;
                          const autoGeneratedHtml = convertTextToHtml(newTextContent, hasLogo);
                          setEditingTemplate({
                            ...editingTemplate, 
                            textContent: newTextContent,
                            htmlContent: autoGeneratedHtml
                        ...
                        placeholder="Write your email content here. URLs and email addresses will become clickable automatically."
                      />
                      <p className="text-xs text-gray-500 mt-1">
                        HTML content will be automatically generated from this text. Use {`{{firstName}}`} and {`{{lastName}}`} for personalization.
                      </p>
                    </div>
