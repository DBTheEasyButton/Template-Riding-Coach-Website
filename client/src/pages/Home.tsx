    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-lg text-dark leading-relaxed mb-8 text-center">If you're dealing with a strong horse, a spooky horse, a lazy horse, or one that rushes into fences or leans on the contact, you're not alone. 
          Many riders feel unsure what to fix first, or how to improve balance, straightness, transitions and confidence. 
          Without a clear training method, progress becomes unpredictable and frustrating.</p>
